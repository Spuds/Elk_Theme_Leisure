...
function template_messages_informations_above()
{
	...
	echo '
		<section id="forumposts" class="forumposts">
			<h1 class="category_header">
...
function template_messages()
{
	...
	while ($message = $controller->{$context['get_message'][1]}())
	{
		...
		echo '
				<section class="post_wrapper ', $message['classes'], $message['approved'] ? ($message['alternate'] == 0 ? ' windowbg' : ' windowbg2') : ' approvebg', '">', $message['id'] != $context['first_message'] ? '

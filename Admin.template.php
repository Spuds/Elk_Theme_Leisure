	...
	foreach ($context['censored_words'] as $vulgar => $proper)
	{
		echo '
					<div class="censorWords">
						<input type="text" name="censor_vulgar[]" value="', $vulgar, '" size="30" /> <i class="fa  fa-arrow-circle-right"></i> 
	...
	if ($context['user']['is_admin'])
	{
		echo '
			<form action="', $scripturl, '?action=admin;area=search" method="post" accept-charset="UTF-8" id="quick_search" class="floatright">
				...
				<button type="submit" name="search_go" id="search_go"><i class="fa fa-search"></i></button>
			</form>';
	}
}
